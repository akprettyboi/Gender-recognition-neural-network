...
from data_process import visualize

warnings.filterwarnings("ignore")

clf_names = ('Nearest Neighbors', 'SVM', 'Decision Tree', 'Random Forest', 'Neural Net', 'XGBoost', 'Stacked Ensemble') # classifier names
clfs = (KNeighborsClassifier(n_neighbors=100, weights='distance'), SVC(), DecisionTreeClassifier(),
        ...
        StackingClassifier(estimators=[('lr', LogisticRegression()), ('rf', RandomForestClassifier())], final_estimator=LogisticRegression())) # classifier objects
